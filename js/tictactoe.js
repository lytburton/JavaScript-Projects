...
function checkWinConditions(){
    ...
    //This conditions checks for tie. If none of the above conditions register and 9
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2){
    ...
    let x1 = coordX1,
        ...
        x = x1,
        //This variable stores temporary y axis data we update in our aniation loop
        y = y1;
...
function animationLineDrawing(){
    ...
    //This is necessarry for the 6, 4, 2 win condition
    if(x1 <= x2 && y1 >= y2){
        if(x < x2){x += 10;}
        if(y > y2){y -=10;}
        if(x >= x2 && y <= y2){cancelAnimationFrame(animationLoop);}
